    ...
    <Card className="p-4 space-y-3 dark:bg-gray-900/60 dark:border-gray-800">
      <div className="grid md:grid-cols-4 gap-3">
        <div className="md:col-span-2">
          <Input placeholder="Search title, description, tags…" value={q} onChange={e=>setQ(e.target.value)} />
        </div>
        <select
      ...
      <div className="flex justify-end gap-2">
        ...
        <Button onClick={() => { setQ(""); setStatus("all"); setPriority(""); router.replace(path); router.refresh(); }}>
          Reset
        </Button>
      </div>
    </Card>
